var gameID = "3", userID, time, lastGameLastLevel, currentdate, sessionData, preloader, centerX = 540/2, centerY = 960/2, picsArray=[];

rushGame.preloader = function () {};
rushGame.preloader.prototype = {
    preload: function(){
