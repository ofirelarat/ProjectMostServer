var gameID = "2", userID, time, lastGameLastLevel, currentdate, sessionData, preloader, centerX = 540/2, centerY = 960/2, picsArray=[];

colorGame.preloader = function () {};
colorGame.preloader.prototype = {
    preload: function(){
